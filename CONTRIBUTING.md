...
In general, we expect you to follow our [Code of Conduct](https://github.com/WeTransfer/concorde.js/blob/master/CODE_OF_CONDUCT.md).
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone git@github.com:WeTransfer/concorde.js.git
   # Navigate to the newly cloned directory
   cd concorde.js
   # Assign the original repo to a remote called "upstream"
   git remote add upstream git@github.com:WeTransfer/concorde.js.git
   ```
